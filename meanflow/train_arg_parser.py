...
def get_args_parser():
    ...
    # OT-MeanFlow specific parameters
    parser.add_argument("--use_ot", action="store_true", default=False,
                        help="Enable Optimal Transport for data-noise pairing")
    parser.add_argument("--ot_method", default="exact", type=str, 
                        choices=["exact", "sinkhorn","partial_ot","lot_group","lot_ind"],
                        help="OT method: 'exact' for linear programming, 'sinkhorn' for entropic regularization")
    parser.add_argument("--ot_reg", default=0.05, type=float,
                        help="Regularization parameter for Sinkhorn algorithm")
    parser.add_argument("--ot_numItermax", default=1000, type=int,
                        help="Maximum number of iterations for Sinkhorn")
    parser.add_argument("--ot_stopThr", default=1e-9, type=float,
                        help="Stop threshold for Sinkhorn")
    return parser
